...
import com.example.eyobtefera.flickster.models.Config;
...
public class MovieListActivty extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_movie_list_activty);
        ...
        client.get(url, params, new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    //goe through all new movies and create Movie objects
